...
<body>
    ...
    <div id="filtros">
        <h5>Tipo : </h5>
        <a href="#" class="category_item" category="BJD">BJD</a> <br>
        <a href="#" class="category_item" category="Momoko">Momoko</a><br>
        ...
        <a href="iframe_Shop1.php" class="category_item" category="arcilla">arcilla</a><br>
